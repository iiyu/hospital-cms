...
<div class="pageContent">
	<form method="post" action="/hgecms/index.php/Admin/Info/doadd" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>条款编码：</label>
				<input name="sort" type="text" size="30" value="100001"/>
			</p>
