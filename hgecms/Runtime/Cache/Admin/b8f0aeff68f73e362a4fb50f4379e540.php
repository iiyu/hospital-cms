...
<div class="pageHeader">
		<div class="subBar">
			<ul>
				<li><a class="buttonActive" target="dialog" href="/hgecms/index.php/Admin/Info/add" ><span>新建信息类型</span></a></li>
			</ul>
		</div>
	</div>
</div>
		...
		<tbody>
			<tr target="sid_user" rel="1">
				...
				<td>
					...
					<a title="审核" target="dialog" href="/hgecms/index.php/Admin/Info/edit" class="btnEdit">编辑</a>
				</td>
			</tr>
		</tbody>
	</table>
